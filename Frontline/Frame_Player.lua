...
function Frontline.CreatePlayerFrame()
    ...
    modeString:SetPoint("BOTTOMLEFT", icon, "RIGHT", 12, 6)
    ...
    ratingString:SetPoint("TOPLEFT", icon, "RIGHT", 12, -3)
    ...
    seasonScoreString:SetText(seasonWon .. " / " ..seasonCnt)
    ...
    weekScoreString:SetText(weekWon .. " / " ..weekCnt)
